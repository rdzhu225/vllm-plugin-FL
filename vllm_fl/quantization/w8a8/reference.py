...
def w8a8_linear_reference(
    ...
    ``weight`` follows the compressed-tensors checkpoint layout ``[N, K]``.
    This materializes a floating-point accumulator and is intended for tests,
    not runtime kernel selection.
    """
